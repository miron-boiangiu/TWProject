...
{
    public const int MAX_FEEDBACK_LENGTH = 4095;
    ...
    public void Configure(EntityTypeBuilder<Feedback> builder)
    {
        ...
        .HasMaxLength(MAX_FEEDBACK_LENGTH)
        .IsRequired(); // This specifies that this column can be null in the database.

        builder.Property(e => e.Satisfaction)
        .HasConversion(new EnumToStringConverter<FeedbackSatisfactionEnum>())
        .HasMaxLength(255)
        .IsRequired();
