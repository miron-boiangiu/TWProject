...
{
    public Task<ServiceResponse> AddFeedback(FeedbackSatisfactionEnum satisfaction, bool wouldRecommend, string text, UserDTO? requestingUser = null, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// </summary>
    public Task<ServiceResponse<PagedResponse<FeedbackDTO>>> GetFeedbacks(PaginationQueryParams pagination, CancellationToken cancellationToken = default);
}
