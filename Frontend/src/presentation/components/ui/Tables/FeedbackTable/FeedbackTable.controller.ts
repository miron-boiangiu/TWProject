...
import { useGetFeedback } from "@infrastructure/apis/api-management/useFeedback";

/**
 * This is controller hook manages the table state including the pagination and data retrieval from the backend.
 */
interface useFeedbackTableControllerInterface {
    query: string
}
...
export const useFeedbackTableController = () => {
    ...
    const { data, isError, isLoading, queryKey } = useGetFeedback(page, pageSize); // Retrieve the table page from the backend via the query hook.
